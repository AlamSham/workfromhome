...
const env = {
  ...
  ingestEnableHimalayas: parseBoolean(process.env.INGEST_ENABLE_HIMALAYAS, true),
  ingestEnableWwr: parseBoolean(process.env.INGEST_ENABLE_WWR, true),
  ...
  himalayasApiUrl: process.env.HIMALAYAS_API_URL || 'https://himalayas.app/jobs/api',
  ...
  alertDigestJobLimit: Number(process.env.ALERT_DIGEST_JOB_LIMIT) || 12,
