        ...
        {jobs.map((job) => {
          ...
          return (
            <Link
              key={job._id}
              href={getJobPath(job)}
              className="group flex flex-col justify-between glass-card p-5 rounded-2xl hover:-translate-y-1 transition-transform border-l-[3px] border-l-transparent hover:border-l-blue-600"
            >
              <div className="flex gap-3 mb-3">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 line-clamp-2 leading-tight group-hover:text-blue-600 transition-colors">
                    {label}
                  </h4>
              ...
              <div className="mt-auto flex items-center justify-between pt-3 border-t border-slate-100">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="badge badge-dark text-[10px] px-2 py-0.5">
                    🏠 Remote
                  </span>
                </div>
